...
A: The only way to get to the next 10x is through reuse. Not w/ complicate parts but with simple composition. More expressive.


The realy problem: we operate in a really poor operational model. Mutation and nulls everywhere. Programmers don't even question it.

Q: What are key elements?

A: Composibility (reuse), Isolation (testing), Immutability (understanding), Discriminant unions (manage lifecycle; MISU)
